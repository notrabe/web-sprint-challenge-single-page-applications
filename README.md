...
useRouteMatch is used for getting access to a route's match data.
1. How would you explain form validation to someone who has never programmed before?
Form validation enures that all of the data in a form's field is correct.
1. In 1-2 sentences, define end to end testing.
end to end testing tests the flow of an application from start to finish
